...
import com.mttnow.android.appthemoviedb.data.apiNetwork.TMDBConnect
...
//        setContentView(bindingMain.root)
        ...
        /*bindingMain.rvMovieList.layoutManager = gridLayoutManager
        bindingMain.rvMovieList.setHasFixedSize(true)
        bindingMain.rvMovieList.adapter = movieAdapter*/
        ...
        viewModel.networkState.observe(this, Observer {
            ...
            txt_error_popular.visibility = if (viewModel.listIsEmpty() && it == NetworkState.ERROR
            ) View.VISIBLE else View.GONE

           /* bindingMain.progressBarPopular.visibility = if (viewModel.listIsEmpty() && it == NetworkState.LOADING
            ) View.VISIBLE else View.GONE
            bindingMain.txtErrorPopular.visibility = if (viewModel.listIsEmpty() && it == NetworkState.ERROR
            ) View.VISIBLE else View.GONE*/
